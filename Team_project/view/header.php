...
<!-- Mirrored from htmldemo.net/junko/junko/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Nov 2024 15:15:49 GMT -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="public/layout/assets/img/favicon.ico">

    <!-- CSS 
    ========================= -->

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="public/layout/assets/css/plugins.css">
...
<body>
    ...
    <section class="slider_section slider_section_three mb-70">
        <div class="slider_area owl-carousel">
            <div class="single_slider d-flex align-items-center" data-bgimg="public/layout/assets/img/slider/slider4.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="single_banner mb-30">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="public/layout/assets/img/bg/banner1.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="single_banner mb-30">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="public/layout/assets/img/bg/banner2.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3">
                    <div class="single_banner mb-30">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="public/layout/assets/img/bg/banner3.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
