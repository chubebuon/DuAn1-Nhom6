                ...
                <section class="shipping_area shipping_two">
                    <div class=" row">
                        <div class="col-lg-3 col-md-6">
                            <div class="single_shipping">
                                <div class="shipping_icone">
                                    <img src="public/layout/assets/img/about/shipping1.png" alt="">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single_shipping">
                                <div class="shipping_icone">
                                    <img src="public/layout/assets/img/about/shipping2.png" alt="">
                                </div>
                                <div class="shipping_content">
                                    <h2>Support 24/7</h2>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single_shipping">
                                <div class="shipping_icone">
                                    <img src="public/layout/assets/img/about/shipping3.png" alt="">
                                </div>
                                <div class="shipping_content">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single_shipping">
                                <div class="shipping_icone">
                                    <img src="public/layout/assets/img/about/shipping4.png" alt="">
                                </div>
                                <div class="shipping_content">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="widgets_container contact_us">
                                <div class="footer_logo">
                                    <a href="#"><img src="public/layout/assets/img/logo/logo.png" alt=""></a>
                                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="footer_payment text-end">
                            <a href="#"><img src="public/layout/assets/img/icon/payment.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="modal_tab">
                                    <div class="tab-content product-details-large">
                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                                            ...
                                            <a href="#"><img src="public/layout/assets/img/product/product1.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab2" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="public/layout/assets/img/product/product2.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab3" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="public/layout/assets/img/product/product3.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab4" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="public/layout/assets/img/product/product5.jpg" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
...
<!-- Mirrored from htmldemo.net/junko/junko/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Nov 2024 15:15:50 GMT -->
